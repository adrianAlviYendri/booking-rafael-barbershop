...
class BottomSheetAddHairStyle extends StatelessWidget {
  const BottomSheetAddHairStyle({
    super.key,
  });
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() => controller.pickedFile.value != null &&
              ...
              : GestureDetector(
                  onTap: () {
                    controller.selectImageHairStyle();
                  },
                  child: Container(
                    height: 200,
                    width: double.infinity,
          ...
          TextFormField(
            controller: controller.namaHairStyleController,
