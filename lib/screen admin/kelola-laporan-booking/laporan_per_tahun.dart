...
class LaporanPerTahunScreen extends StatelessWidget {
  const LaporanPerTahunScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Laporan Per Tahun'),
        actions: [
          IconButton(
            ...
            onPressed: () async {
              if (controller.dataBooking.isNotEmpty) {
                final pdfData = await controller.generatePdf(
                    ...
                    controller.totalRevenuePerYear,
                    'Tahun');
      ...
      body: Padding(
        ...
        child: Column(
          children: [
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<int>(
                    hint: Text(selectedYear.value > 0
                        ...
                        : 'Pilih Tahun'),
                    value: selectedYear.value > 0 ? selectedYear.value : null,
                    items:
                    ...
                    onChanged: (value) {
                      ...
                      controller.getDataBooking(year: selectedYear.value);
                    },
                  ),
                ),
              ),
            ...
            Obx(
              () => Text(
                'Total Pendapatan Tahun Ini : Rp.${controller.totalRevenuePerYear}',
