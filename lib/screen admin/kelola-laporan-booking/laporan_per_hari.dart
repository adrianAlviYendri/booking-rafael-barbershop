...
class LaporanPerhariScreen extends StatelessWidget {
  const LaporanPerhariScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Laporan Per Hari'),
        actions: [
          IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
                    ...
                    () => InputDecorator(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<int>(
                          hint: Text(selectedDay.value > 0
                              ? selectedDay.value.toString()
                              : 'Pilih Hari'),
                          value:
                              selectedDay.value > 0 ? selectedDay.value : null,
            ...
            Obx(
              () => Text(
                'Total Pendapatan : Rp.${controller.totalRevenuePerDay}',
